    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime(2018, 12, 31, 13, 56, 36, 502735), verbose_name='添加时间')),
            ],
            options={
                'verbose_name': '订单',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime(2018, 12, 31, 13, 56, 36, 501735), verbose_name='添加时间')),
